...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.encoder = nn.LSTM(embed_size, self.hidden_size, 1, bias=True, bidirectional=True)
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        e_t = torch.squeeze(enc_hiddens_proj.bmm(torch.unsqueeze(dec_hidden, 2)), dim=-1)
        ...
        a_t = torch.squeeze(torch.unsqueeze(alpha_t, 1).bmm(enc_hiddens), dim=1)
